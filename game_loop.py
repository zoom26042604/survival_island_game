"""Small, focused game loop that imports CLI helpers from src.ui.cli.

Keeping this file short improves readability; UI logic lives in
`src.ui.cli` so it can be reused or tested separately.
"""
